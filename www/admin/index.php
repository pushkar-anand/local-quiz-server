...
<form name="admin" method="post" action="#" >
  <input type="user" placeholder="Name" name="name" value="" required autofocus pattern="[A-Za-z-0-9]+\s[A-Za-z-'0-9]+"  title="Firstname Lastname"/>
